...
Toda la estructura se muestra al final de capítulo (\ref{fig:ro_chx1}) en el diagrama
simplificado del layout de una columna de canal, mostrando los bloques más
