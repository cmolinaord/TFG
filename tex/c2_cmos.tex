...
substrato semiconductor se asienta una capa de Óxido aislante y sobre ella un
...
fundamental. El óxido sobre el que se deposita el poly.
...
este polisilicio creará puertas de transistores sobre una fina capa de óxido de silicio.
...
\paragraph{V2-V3-...-(V5)}
Vias. Crean conexiones verticales entre un metal y el
...
\paragraph{}
Las herramientas de CAD (\textit{Computer Asisted Design}) se usan
...
\paragraph{}
Por otra parte, en microelectronica, debemos tener presente que
...
\paragraph{}
Según cada tipo de dispositivo se aplican unas normas recomendadas para
