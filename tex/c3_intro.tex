...
\subsection{Sensores de imagen CCD}\label{cap:ccd_image_sensors}
...
\subsection{Sensores de imagen CMOS}\label{cap:cmos_image_sensors}

\paragraph{}
%WARNING
% Decir algo de los sensores de imagen CMOS en comparacion con los CCD
