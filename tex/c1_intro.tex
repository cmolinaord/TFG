...
\ref{fig:pxa_array} se esquematiza todo lo dicho.\\
...
\paragraph{SPS}. En el bloque digital que se encarga de ordenar en frames y serializar
...
\begin{figure}[h]
	\centering
	\includesvg[width=0.9\textwidth]{svg/sensor_floorplan.svg}
