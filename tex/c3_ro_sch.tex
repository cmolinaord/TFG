...
un área de $5\mu m \times 5\mu m$, y en el que se apilan 2 canales para leer 2
columnas de píxeles. Por tanto, el ancho de un canal será de $10\mu m$, encajando
...
El bloque va a estar compartido por 8 canales (80$\mu m$ de anchura).
...
$I_0=125\text{nA}$. De forma que podemos variar la corriente total entre $125\text{nA}$ y
$3.875\mu \text{A}$, en pasos de $125\text{nA}$.
